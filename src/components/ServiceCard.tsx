...
import { LucideIcon, MessageCircle, Code, Palette } from 'lucide-react';
...
const ServiceCard = ({ icon: Icon, title, description, features, price, gradient, delay = 0 }: ServiceCardProps) => {
  ...
  return (
    <div 
      className="group relative bg-white/10 backdrop-blur-md rounded-3xl p-6 sm:p-8 border border-white/20 hover:border-white/40 transition-all duration-500 hover:transform hover:scale-105 hover:shadow-2xl animate-slide-up overflow-hidden cursor-pointer"
    ...
    >
      ...
      {/* Price Section - Only shown when card is clicked */}
      {showPrice && (
        <div className="relative z-10 animate-fade-in">
          <div className="text-xl sm:text-2xl font-bold text-white mb-6 text-center">
            {price}
          </div>
